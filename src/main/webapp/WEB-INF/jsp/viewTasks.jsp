...
function backPage(){
	window.open('<c:url value="/task/home"/>','_self',false);
}
function openCreateTaskForm(){
	window.open('<c:url value="/task/showCreate?from=view"/>','_self',false);
}
...
<td><a href="/task/showEdit/${task.id}" class="btn btn-primary">Edit</a></td>
