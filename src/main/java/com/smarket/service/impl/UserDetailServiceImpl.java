...
//			DbUser dbUser = userDAO.searchDatabase(username);
			...
			com.smarket.model.User persistedUser = userService.getUserByEmail(username);
			System.out.println("persistedUser");
			System.out.println(persistedUser.getPassword().toLowerCase());
			...
			user =  new User(
                    ...
                    persistedUser.getPassword().toLowerCase(),
                    true,
                    true,
                    true,
                    true,
                    getAuthorities(2)); //persistedUser.getAccess()
